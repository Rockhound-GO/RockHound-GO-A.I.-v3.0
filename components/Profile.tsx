  ...
  return (
    <div className="h-full flex flex-col bg-[#050a10] overflow-y-auto no-scrollbar relative font-sans perspective-1000 pb-20">
      ...
      <div className="relative z-20 flex items-center justify-between p-6">
        ...
        <button aria-label="Close profile" onClick={() => { playSound('click'); onBack(); }} className="p-2 rounded-full text-gray-400 hover:text-white transition-colors border border-transparent hover:border-white/10"><X className="w-6 h-6" /></button>
      </div>
