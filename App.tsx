    ...
    <div className="flex flex-col h-screen w-screen relative overflow-hidden bg-[#030508] text-gray-100 font-sans">
      ...
      <header className="flex-none bg-[#050a10]/60 backdrop-blur-2xl border-b border-white/5 px-6 py-5 flex items-center justify-between z-40">
        ...
        <div className="flex items-center gap-5">
            ...
            <button onClick={() => handleViewChange(View.FUSION)} aria-label="Open Fusion Lab" title="Fusion Lab" className="p-3 rounded-2xl bg-purple-500/10 border border-purple-500/30 text-purple-400 hover:bg-purple-500/20 focus-visible:ring-2 focus-visible:ring-purple-500 transition-all"><Beaker size={20} /></button>
            <button onClick={() => setShowClover(true)} aria-label="Open CLOVER Assistant" title="CLOVER Assistant" className="p-3 rounded-2xl bg-indigo-500/10 border border-indigo-500/30 text-indigo-400 hover:bg-indigo-500/20 focus-visible:ring-2 focus-visible:ring-indigo-500 transition-all"><Cpu size={20} /></button>
        </div>
      </header>
      ...
      <nav className="flex-none bg-[#050a10]/90 backdrop-blur-3xl border-t border-white/5 pb-safe z-40 relative px-6">
        <div className="flex justify-between items-center h-24">
          ...
          <div className="relative -top-10">
             <button onClick={() => handleViewChange(View.SCANNER)} aria-label="Open Scanner" title="Scanner" className="w-24 h-24 rounded-full bg-gradient-to-tr from-cyan-400 via-indigo-600 to-purple-600 p-[3px] shadow-[0_0_50px_rgba(79,70,229,0.5)] active:scale-90 focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-2 focus-visible:ring-offset-black transition-transform">
